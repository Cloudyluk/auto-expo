...
| 官网链接覆盖 | 94.7% | 5.3% | 608 条记录中 576 条已有来源或官方链接，32 条仍待补 |
| 官网补充批次 | 11 批 / 11 批 | 第十二批继续 | 已新增 360 条规则；从第五批开始按每批 40 条独立检查和提交 |
...
gantt
    ...
    section 待完成：数据治理
    官网链接第十二批及后续批次       :active, links12, after links11done, 8d
...
- 已覆盖：576 / 608 条记录。
- 待补充：32 / 608 条记录。
- 从第五批开始按每批 40 个官网计算，约还需要 1 批；最后一批可能少于 40 个。
