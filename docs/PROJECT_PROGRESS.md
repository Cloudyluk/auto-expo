...
| 重点字段补齐 | 98 / 608 条 | 510 条 | 已完成四批并完成第五批检查，累计推进 98 条海外重点记录 |
...
gantt
    ...
    字段治理第五批 20 条             :active, fields5, after fields4, 1d
...
- 重点字段当前覆盖：详细地址 102 条、适合人群 111 条、官方来源 72 条；本批完成 20 条海外重点记录。
